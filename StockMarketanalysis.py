...
**RSI Value**: {rsi_value:.2f} → {'📈 Overbought' if rsi_value > 70 else '📉 Oversold' if rsi_value < 30 else '🟡 Neutral'}  
**Trend Signal**: {'🟢 Bullish' if df['Close'].iloc[-1] > df['SMA_20'].iloc[-1] else '🔴 Bearish'}
"""
st.markdown(summary)
